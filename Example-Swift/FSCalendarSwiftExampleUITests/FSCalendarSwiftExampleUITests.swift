...
class FSCalendarSwiftExampleUITests: XCTestCase {
    ...
    func testDIY() {
        ...
        var swipeStart: XCUICoordinate = calendar.coordinate(withNormalizedOffset: CGVector(dx: 0.75/7.0, dy: 0.5))
        ...
        calendar.swipeUp()
        calendar.swipeLeft()
        swipeStart = calendar.coordinate(withNormalizedOffset: CGVector(dx: 0.75/7.0, dy: 0.75))
