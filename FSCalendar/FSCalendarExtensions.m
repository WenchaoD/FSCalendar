...
- (void)setFs_x:(CGFloat)fs_x {
	CGRect frame = CGRectMake(fs_x, self.fs_y, self.fs_width, self.fs_height);
	self.frame = frame;
}
...
- (void)setFs_y:(CGFloat)fs_y{
	CGRect frame = CGRectMake(self.fs_x, fs_y, self.fs_width, self.fs_height);
	self.frame = frame;
}
...
- (void)setFs_Origin:(CGPoint)fs_origin {
	self.fs_x = fs_origin.x;
	self.fs_y = fs_origin.y;
}
...
- (void)setFs_Right:(CGFloat)fs_right {
	self.fs_x = fs_right - self.fs_width;
}

- (CGFloat)fs_right {
	return self.fs_x + self.fs_width;
}
